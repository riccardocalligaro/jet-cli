...
import 'package:jet_cli/src/json_to_model/core/command.dart';
import 'package:jet_cli/src/json_to_model/core/json_model.dart';
import 'package:jet_cli/src/json_to_model/utils/faker_maker.dart';
...
class DartDeclaration {
  ...
  String checkNestedTypes(String type, NestedCallbackFunction callback) {
    ...
    final importExists =
        imports.indexWhere((element) => element == cleanType.toSnakeCase()) !=
            -1;
